import { getFacilities, getRegions, getDistricts, getTraditionalAuthorities, getVillages } from "@/utils/HisFormHelpers/LocationFieldOptions";
    ...
    getHomeTaField() {
        return {
            ...
            config: {
                ...
                footerBtns: [this.addCustomLocationBtnForTAorVillage("TA", "home_district")],
            },
    ...
    getHomeVillageField() {
        return {
            ...
            config: {
                showKeyboard: true,
                isFilterDataViaApi: true,
                footerBtns: [this.addCustomLocationBtnForTAorVillage("Village", "home_traditional_authority")],
            },
            requireNext: false,
            defaultOutput: () => ({ label: "N/A", value: "N/A" }),
            defaultComputedOutput: (f: any) => {
    ...
    getCurrentTAfield() {
        return {
            ...
            config: {
                showKeyboard: true,
                isFilterDataViaApi: true,
                footerBtns: [this.addCustomLocationBtnForTAorVillage("TA", "current_district")],
            },
            defaultOutput: () => ({ label: "N/A", value: "N/A" }),
            defaultComputedOutput: (f: any) => {
                if (f.current_region && f.current_region.label.match(/foreign/i)) {
    ...
    getCurrentVillageField() {
        return {
            ...
            config: {
                showKeyboard: true,
                isFilterDataViaApi: true,
                footerBtns: [this.addCustomLocationBtnForTAorVillage("Village", "current_traditional_authority")],
            },
            defaultOutput: () => ({ label: "N/A", value: "N/A" }),
            defaultComputedOutput: (f: any) => {
                if (f.current_region && f.current_region.label.match(/foreign/i)) {
