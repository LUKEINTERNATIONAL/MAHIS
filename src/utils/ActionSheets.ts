...
export async function listActionSheet(title: string, subtitle: string, list: Array<string>, actionButtons: Array<any>, color = "") {
    const modal = await modalController.create({
        component: ListSheet,
        backdropDismiss: false,
        cssClass: "action-sheet-modal",
...
export async function infoActionSheet(title: string, bodyTitle: string, bodyText: string, actionButtons: Array<any>, color = "") {
    const modal = await modalController.create({
        component: InfoSheet,
        backdropDismiss: false,
        cssClass: "action-sheet-modal",
...
export async function optionsActionSheet(
    ...
    console.log("optionsActionSheet", JSON.stringify(list));
    const modal = await modalController.create({
    ...
    console.log("optionsActionSheet", JSON.stringify(modal));
    await modal.present();
    sanitizeModal();
    const { data } = await modal.onDidDismiss();
    return data;
