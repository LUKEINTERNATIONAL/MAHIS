...
function exportMobile(file: string, data: any, type: "blob" | "text") {
    ...
    if (promiseObj != null) {
        promiseObj.then(() => toastSuccess(`File exported to "Documents/${path}"!`, 3000)).catch((e: any) => toastDanger(e));
    }
}
...
export function toTablePDF(tableColumns: Array<any>, tableRows: Array<any>, fileName = "document", canHorizontalPageBreak = false, encryption = {}) {
