<template>
    <ion-row class="centered-content">
        <div class="text-container">
            <div>Do you want to send SMS reminder?</div>
        </div>
    </ion-row>
    ...
    <div class="saveBtn">
        <ion-row>
            <ion-col>
                <ion-button @click="dismissModal" id="cbtn" class="btnText cbtn" fill="solid" style="width: 130px"> No </ion-button>
            </ion-col>

            <ion-col>
                <ion-button @click="sendSMS" class="btnText" fill="solid" style="width: 130px; text-align: right"> Yes </ion-button>
            </ion-col>
        </ion-row>
    </div>
</template>
