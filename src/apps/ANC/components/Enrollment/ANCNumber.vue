...
export default defineComponent({
    ...
    async mounted() {
        ...
        modifyFieldValue(this.ANCNumber, "ANCNumber", "value", j.ncd_number.replace(/^\D+|\s/g, ""));
        modifyFieldValue(this.ANCNumber, "ANCNumber", "leftText", `${j.ncd_number.replace(/\d+/g, "")}-ANC-`);
        this.buildCards();
    },
    methods: {
        buildCards() {
            this.cardData = {
                ...
                cards: [
                    {
                        cardTitle: "ANC number",
                        content: this.ANCNumber,
                    },
                ],
            };
        },
        ...
        updateEnrollmentStores() {
            ...
            enrollmentStore.setANCNumber(this.ANCNumber);
        },
        testF(data: any) {
            console.log(data);
        },
