...
import { modifyRadioValue, modifyCheckboxValue, getRadioSelectedValue, getCheckboxSelectedValue, modifyFieldValue } from "@/services/data_helpers";
    ...
    methods: {
        ...
        handleRespirationExam() {
            if (getCheckboxSelectedValue(this.respiration, "Other respiratory exam") == "other respiratory exam") {
                ...
                modifyFieldValue(this.respiration, "Other", "displayNone", true);
            }
        },
