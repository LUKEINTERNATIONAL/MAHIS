...
export default defineComponent({
  ...
  computed:{
    ...
    "Systolic blood pressure"(){return getFieldValue(this.vitals,'Systolic blood pressure','value') },
    "Diastolic blood pressure"(){return getFieldValue(this.vitals,'Diastolic blood pressure','value') },
    "Pulse"(){return getFieldValue(this.vitals,'Pulse','value') },
    "Temp"(){return getFieldValue(this.vitals,'Temp','value') },
    "Respiratory rate"(){return getFieldValue(this.vitals,'Respiratory rate','value') }
  },
  mounted(){
