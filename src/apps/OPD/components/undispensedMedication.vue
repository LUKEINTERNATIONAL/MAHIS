...
import { undispensedStore } from "@/apps/OPD/store/undispensedList";
...
export default defineComponent({
    ...
    name: "xxxComponent",
    computed: {
        ...mapState(undispensedStore, ["undispensedMedications"]),
        ...mapState(undispensedStore, ["undispensedMedication"]),
...
// const reasonsList: Array<{label: string; code: string; value: number; [x: string]: any}> = [
//     { label : "Out of stock", code : "OS", value : 1 },
//     { label : "Wrong Prescription", code : "BD", value : 2 },
