                ...
                <div class="visitData">
                    ...
                    <div v-if="levelOfConsciousness.eyeResponse || levelOfConsciousness.verbalResponse || levelOfConsciousness.motorResponse">
                        <div>
                            ...
                            <div class="levelOfConsciousnessContent" v-if="levelOfConsciousness.eyeResponse">
                                Eye opening response: <span style="font-weight: normal !important">{{ levelOfConsciousness.eyeResponse }}</span>
                            </div>
                            <div class="levelOfConsciousnessContent" v-if="levelOfConsciousness.verbalResponse">
                                Best verbal response: <span style="font-weight: normal !important">{{ levelOfConsciousness.verbalResponse }}</span>
                            </div>
                            <div class="levelOfConsciousnessContent" v-if="levelOfConsciousness.motorResponse">
                                Best motor response: <span style="font-weight: normal !important">{{ levelOfConsciousness.motorResponse }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="pregnancy.patientPregnant || pregnancy.breastFeeding">
                        <div>
                            ...
                            <div class="levelOfConsciousnessContent" v-if="pregnancy.patientPregnant">
                                Is the patient pregnant?: <span style="font-weight: bold !important">{{ pregnancy.patientPregnant }}</span>
                            </div>
                            <div class="levelOfConsciousnessContent" v-if="pregnancy.breastFeeding">
                                Is the patient breast feeding?: <span style="font-weight: bold">{{ pregnancy.breastFeeding }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <div v-if="uniqueHeartSoundsAbnormal?.length > 0" class="physicalExam">
                                ...
                                <div style="display: flex; flex-wrap: wrap">
                                    <div
                                        class="levelOfConsciousnessContent"
                                        v-for="(heartSoundsAbnormality, index) in uniqueHeartSoundsAbnormal"
                                        :key="index"
                                    >
                            ...
                            <div v-if="uniqueBreathSoundsAbnormal?.length > 0" class="physicalExam">
                                ...
                                <div style="display: flex; flex-wrap: wrap">
                                    <div
                                        class="levelOfConsciousnessContent"
                                        v-for="(breathSoundsAbnormality, index) in uniqueBreathSoundsAbnormal"
                                        :key="index"
                                    >
                            ...
                            <div v-if="uniqueAddedBreathSoundsAbnormal?.length > 0" class="physicalExam">
                                ...
                                <div style="display: flex; flex-wrap: wrap">
                                    <div
                                        class="levelOfConsciousnessContent"
                                        v-for="(addedBreathSoundsAbnormality, index) in uniqueAddedBreathSoundsAbnormal"
                                        :key="index"
                                    >
                            ...
                            <div v-if="uniqueAbdominalInspectionAbnormal?.length > 0" class="physicalExam">
                                ...
                                <div style="display: flex; flex-wrap: wrap">
                                    <div
                                        class="levelOfConsciousnessContent"
                                        v-for="(abdominalInspectionAbnormality, index) in uniqueAbdominalInspectionAbnormal"
                                        :key="index"
                                    >
    ...
    methods: {
        ...
        async setLevelOfConsciousnessEncounters(data: any) {
            ...
            if (observations && Array.isArray(observations)) {
                ...
                this.levelOfConsciousness.eyeResponse =
                    eyeResponseObs.length > 0 ? await ConceptService.getConceptName(eyeResponseObs[0].value_coded) : "";
                const verbalResponseObs = this.filterObs(observations, "Best verbal response");
                this.levelOfConsciousness.verbalResponse =
                    verbalResponseObs.length > 0 ? await ConceptService.getConceptName(verbalResponseObs[0].value_coded) : "";
                const motorResponseObs = this.filterObs(observations, "Best motor response");
                this.levelOfConsciousness.motorResponse =
                    motorResponseObs.length > 0 ? await ConceptService.getConceptName(motorResponseObs[0].value_coded) : "";
            }
        },
        async setPregnancyStatusEncounters(data: any) {
            ...
            if (observations && Array.isArray(observations)) {
                ...
                this.pregnancy.patientPregnant =
                    patientPregnantObs.length > 0 ? await ConceptService.getConceptName(patientPregnantObs[0].value_coded) : "";
                const breastFeedingObs = this.filterObs(observations, "Is patient breast feeding?");
                this.pregnancy.breastFeeding =
                    breastFeedingObs.length > 0 ? await ConceptService.getConceptName(breastFeedingObs[0].value_coded) : "";
            }
        },
