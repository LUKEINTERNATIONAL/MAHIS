<template>
    <div class="my-table" style="margin: auto; width: 95%; margin-top: 3%; margin-bottom: 3%">
        <report-table :columns="columns" :rows="rows" :config="{ tableCssTheme }"> </report-table>
    </div>
</template>
    ...
    methods: {
        ...
        onDownload(reportTitle = "") {
          ...
          Site UUID: ${Service.getSiteUUID()}`;
            ...
            const _navigator_cp = navigator as any;
        ...
        buildRows(data: any): RowInterface[][] {
            ...
            data.forEach((condition: { id: number; name: string; total: number; totalPatientIds: any }) => {
                rows.push([
