...
export const SecondStageDetailsSchema = yup.object().shape({
    ...
    "Number of babies":  yup.number().transform((value,originalValue)=>{
        return originalValue === '' ? null : value;
    }).nullable().min(1).when('Baby general condition at birth', ([babyCondition], schema:any)=>{
      ...
      data: [
        {
          ...
          value:
            "Skilled health worker (Nurse midwife/community midwife assistant/medical assistant/clinical technician/medical doctor",
          colSize: "12",
        },
        {
          name: "Unskilled (Patient attendant/ ward attendant/ health surveillance assistant/other/none",
          value:
            "Unskilled (Patient attendant/ ward attendant/ health surveillance assistant/other/none",
          colSize: "12",
        },
        {
