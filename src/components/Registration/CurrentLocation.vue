...
export default defineComponent({
    ...
    methods: {
        ...
        async buildDistricts() {
            this.locationData =
                this.setName === "homeLocation" ? this.homeLocation : this.currentLocation;
        ...
        async handleDisplayNone(targetData: any, inputField: any) {
            if (
                ...
                this.setName === "homeLocation"
                    ? (this.homeLocation[1 + inputField].data.rowData[0].colData[0].displayNone =
                          false)
                    : (this.currentLocation[1 + inputField].data.rowData[0].colData[0].displayNone =
                          false);
            } else {
