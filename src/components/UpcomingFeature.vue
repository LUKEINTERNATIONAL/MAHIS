<template>
    <div class="alert">
        <h3>Stay tuned for our new features coming soon!</h3>
        <div class="message">
            <!-- Upcoming feature message for HTML-only example -->
            Exciting new features will be available soon. Check back later!
        </div>
    </div>
</template>
