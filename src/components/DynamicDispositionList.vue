<template>
    <ion-item
        ...
        <ion-col class="action_buttons">
            <ion-label :class="asignSpanLblID(index)" style="cursor: pointer; display: none; text-align: end;" @click="editItemAtIndex(index,item, $event)"><ion-icon   :icon="iconsContent.edit"></ion-icon></ion-label>
