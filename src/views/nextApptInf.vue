<template>
    <ion-card style="margin-bottom: 10px">
        <ion-card-content style="padding: 2px">
            ...
            <ion-grid>
                <ion-row>
                    <ion-col size="6"> <strong>Name:</strong> {{ person.name }} </ion-col>
                    <ion-col size="5"> <strong>Gender:</strong> {{ person.gender }} </ion-col>
                </ion-row>
                <ion-row>
                    <ion-col size="6"> <strong>Age/DOB:</strong> {{ person.ageDob }} </ion-col>
                    <ion-col size="6"> <strong>Village:</strong> {{ person.village }} </ion-col>
                </ion-row>
                <ion-row>
                    <ion-col size="12"> <strong>Appointment Date:</strong> {{ person.appointmentDate }} </ion-col>
                </ion-row>
