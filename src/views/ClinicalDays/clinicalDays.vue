<template>
    <div class="ion-padding" style="max-width: 90%; margin-left: 5%">
                    ...
                    <ion-row>
                        <ion-col size="12" size-md="6">
                            <ion-checkbox
                                class="ilbl"
                                label-placement="end"
                                v-model="isMondayChecked"
                                @ionChange="onCheckboxChange($event, 'monday')"
                            >
                            ...
                            <ion-checkbox
                                class="ilbl"
                                label-placement="end"
                                v-model="isTuesdayChecked"
                                @ionChange="onCheckboxChange($event, 'tuesday')"
                            >
                            ...
                            <ion-checkbox
                                class="ilbl"
                                label-placement="end"
                                v-model="isWednesdayChecked"
                                @ionChange="onCheckboxChange($event, 'wednesday')"
                            >
                            ...
                            <ion-checkbox
                                class="ilbl"
                                label-placement="end"
                                v-model="isThursdayChecked"
                                @ionChange="onCheckboxChange($event, 'thursday')"
                            >
                            ...
                            <ion-checkbox
                                class="ilbl"
                                label-placement="end"
                                v-model="isFridayChecked"
                                @ionChange="onCheckboxChange($event, 'friday')"
                            >
                            ...
                            <ion-row>
                                ...
                                <ion-col size="8">
                                    <div class="mt-30">
                                        <ion-checkbox
                                            class="ilbl"
                                            :disabled="disable_weekends"
                                            label-placement="end"
                                            v-model="isSaturdayChecked"
                                            @ionChange="onCheckboxChange($event, 'saturday')"
                                        >
                                        ...
                                        <ion-checkbox
                                            ...
                                            :disabled="disable_weekends"
                                            label-placement="end"
                                            v-model="isSundayChecked"
                                            @ionChange="onCheckboxChange($event, 'sunday')"
                                        >
                                ...
                                <ion-row>
                                    <ion-col>
                                        <ion-row>
                                            ...
                                            <ion-col>
                                                <ion-button fill="solid" @click="autoGen" class="btn-cls-2" style="float: right">
        ...
        <ion-row v-if="false">
            <ion-col>
                <ion-button fill="solid" @click="saveAction" class="btn-cls-2" style="float: right">
