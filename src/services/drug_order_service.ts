...
export class DrugOrderService extends Service {
    ...
    static drugOrders(patientID: number) {
    ...
    static findProgramDrugOrdersAwaitingDispensation(patientID: number, date = this.getSessionDate()) {
